// DrillBot.cpp: implementation of the DrillBot class.
//
//////////////////////////////////////////////////////////////////////
...
DrillBot::DrillBot(int inY, int inX, direction_t inDirection, 
...
void DrillBot::collide()
{
	if(!getExploding()) {
		...
		case PIT:
			...
			break;
		case DRILLABLE:
			getBoard()->setPrimaryTerrainAt(getY(), getX(), FLOOR);
			break;
		case UPARROW: 
		case R_UPARROW:
			setDirection(UP);
