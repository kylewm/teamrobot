// Undeployed.cpp: implementation of the Undeployed class.
//
//////////////////////////////////////////////////////////////////////
...
Undeployed::Undeployed(int inY, int inX, direction_t inDirection, 
	...
	if(!getExploding()) {
		...
		for(int i = 0; i < curML.size(); ++i) {
			if((curML.at(i) != this) && !(curML.at(i)->getHeadOn()) && curML.at(i)->getDeployedOnBoard()) {
				if(curML.at(i)->getInTrain() || getInTrain()) {
